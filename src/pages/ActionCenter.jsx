              ...
              {paginatedTasks.length === 0 ? (
                ...
                <tr key={task.id} className={`hover:bg-blue-50/30 transition-colors ${selectedTaskIds.includes(task.id) ? 'bg-blue-50/50' : ''}`}>
                  ...
                  <td className="p-4 text-xs font-medium text-gray-600">
                    {task.assigned_time_display || "-"}
                  </td>
                  <td className="p-4 text-xs font-medium">
                    <span className={task.task_age_seconds > 86400 * 2 ? "text-yellow-600 font-black" : "text-gray-600"}>
                      {task.task_age_seconds != null ? formatTaskAge(task.task_age_seconds) : "-"}
                    </span>
                  </td>
                  <td className="p-4 text-xs font-medium text-gray-600">
                    {task.last_activity_time_display || "-"}
                  </td>
                ...
                >
                  ...
                  <div className="pt-2 border-t border-gray-100 flex flex-col gap-2 relative">
                     <div className="flex items-center justify-between text-[9px] text-gray-400 font-medium">
                        ...
                        <span className="lg:group-hover:opacity-0 transition-opacity">Age: <span className={task.task_age_seconds > 86400 * 2 ? "text-yellow-600 font-black uppercase" : ""}>{task.task_age_seconds != null ? formatTaskAge(task.task_age_seconds) : "-"}</span></span>
                     </div>
